...
Requirements: a dataframe with 1 row per leaf node. The first column will be our describe the label of each leaf node (e.g. Mia Johnson, Liam Johnson etc). This dataframe should also include columns we can map to colour, shape, and tooltips / data_ids for when we make the plot interactive.
