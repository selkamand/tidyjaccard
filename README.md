...
colour, shape, and tooltips (for when we make the plot interactive).

TidyJaccard come pre-packaged with an example dataset
...
If `tidy_pairwise_jaccard_similarity()` is too slow for your liking, get
an easy speed up by using multiple threads.
